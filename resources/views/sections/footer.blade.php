      ...
      <div class="container">
          <div class="row">
              <div class="col-md-3 col-sm-6 widget">
                  <div class="about">
                      <a href="/"><img class="logo" src="{{ $frontThemeSettings->logo_url }}" height="32" alt="Logo"></a>
                      <p>Stanjo Karen Suites is a family-owned hotel facility located along Langata road,opposite Tangaza University.Over looking Ngong Hills and
