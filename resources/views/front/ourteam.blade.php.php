...
<div class="container">
<div class="inner">
<h1>About Zante Hotel</h1>
<ol class="breadcrumb">
<li><a href="index.html">Home</a></li>
<li>About Zante Hotel</li>
</ol>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-7">
<h1 class="mb30">Zante Hotel - Since 1989</h1>
...
<img src="{{ asset('assets/img/gym-spa.jpg') }}" class="img2 img-responsive" alt="Image">
</div>
<div class="row">
...
<a href="{{ asset('assets/img/gym-spa.jpg') }}" class="hover_effect h_lightbox h_blue">
<img src="{{ asset('assets/img/gym-spa.jpg') }}" class="img-responsive full_width br2" alt="Image">
</a>
</div>
<div class="col-md-3 col-sm-6 mt20 mb20 br2">
