...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    function initialize() {
      var map;
      var panorama;
      var var_latitude = -1.349251; // Google Map Latitude
      var var_longitude = 36.747061; // Google Map Longitude
      var pin = 'images/icons/pin.svg';

      //Map pin-window details
      var title = "Stanjo Karen Suites - Click to see";
      var hotel_name = "Stanjo Karen Suites";
      var hotel_address = "Nairobi, Langata Road, Opposite Tangaza University";
      var hotel_desc = "Deluxe Suites";
      var hotel_more_desc = "Affluent residential area with Giraffe Centre park, Karen Blixen Museum & Kenyan crafts galleries.";
